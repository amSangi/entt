...
TEST(Benchmark, IterateTwoComponentsPersistent1M) {
    entt::registry<> registry;
    registry.view<position, velocity>(entt::group_policy);
    ...
    auto test = [&registry](auto func) {
        timer timer;
        registry.view<position, velocity>(entt::group_policy).each(func);
        timer.elapsed();
    };
...
TEST(Benchmark, IterateFiveComponentsPersistent1M) {
    entt::registry<> registry;
    registry.view<position, velocity, comp<1>, comp<2>, comp<3>>(entt::group_policy);
    ...
    auto test = [&registry](auto func) {
        timer timer;
        registry.view<position, velocity, comp<1>, comp<2>, comp<3>>(entt::group_policy).each(func);
        timer.elapsed();
    };
...
TEST(Benchmark, IterateTenComponentsPersistent1M) {
    entt::registry<> registry;
    registry.view<position, velocity, comp<1>, comp<2>, comp<3>, comp<4>, comp<5>, comp<6>, comp<7>, comp<8>>(entt::group_policy);
    ...
    auto test = [&registry](auto func) {
        timer timer;
        registry.view<position, velocity, comp<1>, comp<2>, comp<3>, comp<4>, comp<5>, comp<6>, comp<7>, comp<8>>(entt::group_policy).each(func);
        timer.elapsed();
    };
